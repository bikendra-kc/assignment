...
def register():
    ...
    Label(register_screen, text="Please Register For Your school ID", bg='black', fg='white',
          font=("Times", "20", "bold italic")).pack()
    Label(register_screen, text="").pack()
    username_lable = Label(register_screen, bg='yellow', text="Username * ", font=('STYLE_BRACEBAD, 20'))
    username_lable.pack()
    username_entry = Entry(register_screen, bg='white', fg='black', textvariable=username,
                           font=("Times", "25", "bold italic"))
    username_entry.pack()
    password_lable = Label(register_screen, bg='yellow', text="Password * ", font=('STYLE_BRACEBAD, 20'))
    password_lable.pack()
    password_entry = Entry(register_screen, bg='white', fg='black', textvariable=password, show='*',
                           font=("Times", "25", "bold italic"))

    password_entry.pack()
    Label(register_screen, text="").pack()
    Button(register_screen, text="Register", width=10, height=2, fg='white', bg="red", font=('STYLE_BRACEBAD, 13'),
           command=registerNewUser).pack()
...
def signup():
    ...
    passwordSignupENtry = Entry(signupScreen, bg='yellow', font=('STYLE_BRACEBAD, 20'), textvariable=passwordVerify,
                                show='*')
    passwordSignupENtry.pack()
    Label(signupScreen, text="", font=('STYLE_BRACEBAD, 20')).pack()
    Button(signupScreen, text="Login", bg='red', width=10, height=1, font=('STYLE_BRACEBAD,20'),
           command=signupVerify).pack()
...
def user_not_found():
    ...
    user_not_found_screen = Toplevel(signupSucess())
...
if __name__ == "__main__":
    ...
    Label(text="").pack()
    Button(text="Sign UP", fg='blue', bg='yellow', height="2", width="30", font=('STYLE_BRACEBAD, 15'),
           command=signup).pack()
    Label(text="").pack()
    Button(text="Register", fg='blue', bg='yellow', height="2", width="30", font=('STYLE_BRACEBAD, 15'),
